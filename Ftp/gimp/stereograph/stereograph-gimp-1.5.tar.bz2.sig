...
<script type="text/javascript">window.addEventListener('DOMContentLoaded',function(){var v=archive_analytics.values;v.service='wb';v.server_name='wwwb-app103.us.archive.org';v.server_ms=407;archive_analytics.send_pageview({});});</script><script type="text/javascript" src="/_static/js/playback.bundle.js?v=SOX25l-I" charset="utf-8"></script>
<link rel="stylesheet" type="text/css" href="/_static/css/banner-styles.css?v=bsmaklHF" />
<link rel="stylesheet" type="text/css" href="/_static/css/iconochive.css?v=qtvMKcIJ" />
<script src="/_static/js/jquery-1.11.1.min.js"></script>
</head>
<body style="overflow:hidden;">
<!-- END WAYBACK TOOLBAR INSERT --><iframe id="playback" src="http://trific.ath.cx:80/Ftp/gimp/stereograph/stereograph-gimp-1.5.tar.bz2.sig" frameborder="0" style="position:absolute;top:65px;left:0;width:100%;">
</iframe>
